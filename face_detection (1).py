...
Original file is located at
    https://colab.research.google.com/drive/1Ye_4z71qOaUjGswtCOoiWYFNyyIc1Ukh
...
# Check if a face is detected and label the image accordingly
if face_detected:
    cv2.putText(image, "Face Detected", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
else:
